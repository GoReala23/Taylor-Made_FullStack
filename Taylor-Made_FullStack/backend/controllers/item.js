...
const getItems = async (req, res) => {
  try {
    const localItems = await Item.find(); // Fetch local items
    const thirdPartyProducts = await fetchThirdPartyProducts(); // Fetch third-party items
    const combinedItems = [...localItems, ...thirdPartyProducts];
